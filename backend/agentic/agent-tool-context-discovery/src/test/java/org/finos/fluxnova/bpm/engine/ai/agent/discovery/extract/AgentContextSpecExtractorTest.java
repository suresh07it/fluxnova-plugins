...
class AgentContextSpecExtractorTest {
    ...
    @Test
    void extract_whenNoExtensionElements_returnsEmptyDeclaredVariables() {
        String bpmn = """
    ...
    @Test
    void extract_whenExtensionElementsButNoAgentContext_returnsEmptyDeclaredVariables() {
        String bpmn = """
                <?xml version="1.0" encoding="UTF-8"?>
                <definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL"
    ...
    @Test
    void extract_whenAgentContextPresent_returnsDeclaredVariables() {
        String bpmn = """
                <?xml version="1.0" encoding="UTF-8"?>
                <definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL"
                             xmlns:agent="http://fluxnova.finos.org/schema/1.0/ai/agent">
    ...
    @Test
    void extract_whenAgentContextEmpty_returnsEmptyDeclaredVariables() {
        String bpmn = """
                <?xml version="1.0" encoding="UTF-8"?>
                <definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL"
                             xmlns:agent="http://fluxnova.finos.org/schema/1.0/ai/agent">
    ...
    @Test
    void extract_skipsVariablesWithBlankName() {
        String bpmn = """
                <?xml version="1.0" encoding="UTF-8"?>
                <definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL"
                             xmlns:agent="http://fluxnova.finos.org/schema/1.0/ai/agent">
    ...
    @Test
    void extract_skipsVariablesWithNoNameAttribute() {
        String bpmn = """
                <?xml version="1.0" encoding="UTF-8"?>
                <definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL"
                             xmlns:agent="http://fluxnova.finos.org/schema/1.0/ai/agent">
    ...
    @Test
    void extract_wrongNamespaceForContext_returnsEmptyDeclaredVariables() {
        String bpmn = """
                <?xml version="1.0" encoding="UTF-8"?>
                <definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL"
